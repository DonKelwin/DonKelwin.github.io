...
i2c2 = I2C(1, scl=Pin(11), sda=Pin(10), freq=400000)
i2c3 = I2C(1, scl=Pin(19), sda=Pin(18), freq=400000)
...
#Vergleichsmessung
def messung():
    led_off() #Anpassen für Glow-in-the-dark zu off
    clear_all()
    valid1 = compare_correct(1)
    valid2 = compare_correct(2)
    valid3 = compare_correct(3)
